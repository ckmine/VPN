            ...
            <div class="lc_content">
                <div class="lc_content_product">
                  ...
                  ResultSet rs=null;
                    ResultSet rs1=null;
               %>
               <h3 align="center"><font><strong>BATCH1 List</strong></font></h3><br><br>
               <table  border="">
                   <tr>
                   </tr>
                   <tr bgcolor="#A52A2A">
               ...
               <%
                   try{
                     con=DriverManager.getConnection("jdbc:mysql://localhost:3306/vpn2","root","root");
                         ...
                         String s="select regno,name,course from Registration where course='J2EE' and batch='2pm to 4pm'";
