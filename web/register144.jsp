<%-- 
    Document   : register144
    Created on : Oct 22, 2017, 1:42:57 PM
    Author     : CKmine
--%>
               ...
               <%
                   try{
                     con=DriverManager.getConnection("jdbc:mysql://localhost:3306/vpn2","root","root");
                         ...
                         String s="select regno,name,course from Registration where course='NetWorking' and batch='12pm to 2pm'";
