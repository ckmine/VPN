<%-- 
    Document   : register110
    Created on : Oct 22, 2017, 12:48:03 PM
    Author     : CKmine
--%>
               ...
               <%
                   try{
                     con=DriverManager.getConnection("jdbc:mysql://localhost:3306/vpn2","root","root");
                         ...
                         String s="select regno,name,course from Registration where course='Call Center' and batch='2pm to 4pm'";
