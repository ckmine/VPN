<%-- 
    Document   : register120
    Created on : Oct 22, 2017, 12:48:33 PM
    Author     : CKmine
--%>
               ...
               <%
                   try{
                     con=DriverManager.getConnection("jdbc:mysql://localhost:3306/vpn2","root","root");
                         ...
                         String s="select regno,name,course from Registration where course='Call Center' and batch='4pm to 6pm'";
