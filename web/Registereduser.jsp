<%-- 
    Document   : clientlist1
    Created on : Oct 22, 2017, 6:23:04 PM
    Author     : CKmine
--%>
            ...
            <div class="lc_content">
                <div class="lc_content_product">
                  ...
                  ResultSet rs=null;
                    ResultSet rs1=null;
               %>
               <h3 align="center"><font><strong>Registration User</strong></font></h3><br><br>
               <table  border="">
                   <tr>
                   </tr>
                   <tr bgcolor="#A52A2A">
                       ...
                       <th align='center'>regfee</th>
                       <th align='center'>minstall</th>
